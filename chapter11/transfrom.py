...
distance_run= raw_input('Enter the distance attempted: ')
recorded_time= raw_input('Enter the recorded time: ')
predicted_distance= raw_input('Enter the distance you want a prediction for: ')


closest_time= find_nearest_time(format_time(recorded_time),row_data\
                                [distance_run].keys())
...
print('The predicited time running ' + predicted_distance + ' is; ' + \
      prediction[0] + '.')
